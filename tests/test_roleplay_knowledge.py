...
from main import ROLEPLAY_KNOWLEDGE_ROOT, util  # noqa: E402
...
def test_roleplay_knowledge_searches_split_databases():
    knowledge_base = RoleplayKnowledgeBase.from_root(ROLEPLAY_KNOWLEDGE_ROOT)
...
@pytest.mark.asyncio
async def test_roleplay_knowledge_tool_uses_ema_for_ni():
